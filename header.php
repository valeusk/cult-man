...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<!-- #site-navigation -->
		<div id="brand-target" class="site-branding animated zoomIn" style="">
			...
			<?php else : ?>
				<p  onclick="logo_animate()" class="site-title text__shadow-dark"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></p>
			<?php
			endif;
